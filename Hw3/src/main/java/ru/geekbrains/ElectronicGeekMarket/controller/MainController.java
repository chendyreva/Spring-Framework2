...
import ru.geekbrains.ElectronicGeekMarket.controller.repr.CartItemRepr;
import ru.geekbrains.ElectronicGeekMarket.controller.repr.ProductRepr;
import ru.geekbrains.ElectronicGeekMarket.service.CartService;
...
//    @Value("#{${my.new.property} + ' hohohoho'}")
//    private String myNewProperty;
    ...
    public String updateCart(CartItemRepr cartItemRepr, HttpServletRequest httpServletRequest) {
        ...
        ProductRepr productRepr = (ProductRepr) productService.findById(cartItemRepr.getProductId());
